...
import com.example.islamgsayed.firstapp.pillapp.Model.History;
...
public class AlertActivity extends FragmentActivity {
    ...
    public void doPositiveClick(String pillName){
        ...
        Intent returnHistory = new Intent(getBaseContext(), com.example.islamgsayed.firstapp.pillapp.ViewController.MainActivity.class);
