...
import com.example.islamgsayed.firstapp.cart;
import com.example.islamgsayed.firstapp.pillapp.ViewController.adapter.TabsAdapter;
...
public class MainActivity extends AppCompatActivity implements android.support.v7.app.ActionBar.TabListener {
    ...
    public void sendAdd() {
        Intent intent = new Intent(this, com.example.islamgsayed.firstapp.pillapp.ViewController.AddActivity.class);
        startActivity(intent);
        finish();
    }

    public void sendSetting() {
        Intent intent = new Intent(this, com.example.islamgsayed.firstapp.pillapp.ViewController.ScheduleActivity.class);
        startActivity(intent);
        finish();
    }

    public void sendEdit() {
        Intent intent = new Intent(this, com.example.islamgsayed.firstapp.pillapp.ViewController.PillBoxActivity.class);
        startActivity(intent);
        finish();
    }
}