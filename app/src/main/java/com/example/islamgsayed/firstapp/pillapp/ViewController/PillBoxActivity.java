...
import com.example.islamgsayed.firstapp.pillapp.Model.PillComparator;
import com.example.islamgsayed.firstapp.pillapp.ViewController.adapter.ExpandableListAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        expListView.setOnChildClickListener(new OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v,
                ...
                Intent intent = new Intent(getApplicationContext(), com.example.islamgsayed.firstapp.pillapp.ViewController.EditActivity.class);
